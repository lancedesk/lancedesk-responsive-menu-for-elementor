...
- Off-canvas: Style control **Toggle focus / tap ring** (default hides Chrome/iOS click outline; optional keyboard-only ring)

### 1.0.17

- Off-canvas panel fills to the bottom of the viewport in Elementor editor/device preview (flex layout + visual viewport height sync), matching real devices
