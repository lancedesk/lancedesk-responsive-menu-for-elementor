...
class LDJEM_Security {
    ...
    /**
     * Allowed HTML for plugin-generated menu markup (icons, toggles, links).
     *
     * @return array
     */
    public static function get_allowed_menu_html() {
    ...
    public static function sanitize_menu_markup($html) {
        return wp_kses($html, self::get_allowed_menu_html());
    }
